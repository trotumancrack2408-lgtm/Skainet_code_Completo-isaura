...
let OrdersService = class OrdersService {
    ...
    batchesService;
    alertsService;
    constructor(prisma, usersService, batchesService, alertsService) {
        this.prisma = prisma;
    ...
    async create(data) {
        ...
        if (activeOrder) {
            throw new common_1.BadRequestException('LÍMITE DE TRABAJO EXCEDIDO: El joyero seleccionado ya tiene una pieza en mesa. Debe terminar antes de recibir una nueva.');
        }
        ...
        await this.usersService.updateStatus(executorId, users_service_1.UserStatus.WORKING);
    ...
    async findActiveByExecutor(executorId) {
    ...
    async closeOrder(orderId, finalWeights, explanation, providedPin) {
        ...
        await this.usersService.updateStatus(order.executorId, users_service_1.UserStatus.AVAILABLE);
        if (isAnomaly) {
