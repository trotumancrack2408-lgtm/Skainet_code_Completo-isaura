...
describe('OrdersService - Pruebas Unitarias', () => {
  ...
  it('1. create: Debe crear una orden de trabajo exitosamente y actualizar estado del joyero y anillo (CP-051)', async () => {
  ...
  it('3. create: Debe lanzar BadRequestException si el joyero ejecutor ya tiene una orden abierta (CP-053)', async () => {
  ...
  it('5. closeOrder: Debe cerrar una orden correctamente cuando la merma está en la tolerancia (<= 0.05) (CP-054)', async () => {
    const activeOrder = {
      id: 'ORD-101',
      ringId: 'B-101-R1',
      ringName: 'Anillo 1',
  ...
  it('6. closeOrder: Debe exigir explicación en caso de merma anómala (> 0.05) (CP-055)', async () => {
    const activeOrder = {
      id: 'ORD-101',
      ringId: 'B-101-R1',
      executorId: '1',
