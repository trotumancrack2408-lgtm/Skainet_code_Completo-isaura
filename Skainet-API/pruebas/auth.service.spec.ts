...
describe('AuthService - Pruebas Unitarias', () => {
  ...
  it('1. Debe realizar login exitosamente con credenciales válidas', async () => {
  ...
  it('2. Debe lanzar UnauthorizedException cuando la contraseña sea incorrecta', async () => {
  ...
  it('3. Debe lanzar UnauthorizedException cuando el usuario no existe', async () => {
    (usersService.validatePassword as jest.Mock).mockResolvedValue(null);
