...
import { UsersService, UserStatus } from '../../Skainet-API/src/users/users.service';
...
describe('PRUEBAS DE INTEGRACIÓN - Órdenes de Trabajo (RF-005)', () => {
   ...
   * Tipo: INTEGRACIÓN
   * Objetivo: Consulta de OT por estado.
   * Criterio de Aceptación: Filtrar órdenes de trabajo desde BD según su estado (OPEN, CLOSED).
   * --------------------------------------------------------------------------
   */
  describe('CP-102: Consulta de OT por estado', () => {
    it('Debe obtener las órdenes de trabajo filtradas por su estado en la base de datos', async () => {
      prismaMock.workOrder.findMany.mockResolvedValue([
        { id: 'ORD-101', status: 'OPEN', ringName: 'Anillo 1', startTime: new Date() },
      ]);
   ...
   * Requerimiento: RF-005
   * Tipo: INTEGRACIÓN
   * Objetivo: Reasignación de OT.
   * Criterio de Aceptación: Permitir la reasignación de una OT activa a un nuevo Joyero ejecutor.
   * --------------------------------------------------------------------------
   */
   ...
   * Requerimiento: RF-005
   * Tipo: INTEGRACIÓN
   * Objetivo: Historial de estados de OT.
   * Criterio de Aceptación: Almacenar fecha de inicio, fecha de fin y duración calculada en minutos.
   * --------------------------------------------------------------------------
   */
   ...
   * Requerimiento: RF-005
   * Tipo: INTEGRACIÓN
   * Objetivo: Auditoría eventos de OT.
   * Criterio de Aceptación: Verificar trazabilidad de eventos de producción en auditoría.
   * --------------------------------------------------------------------------
   */
