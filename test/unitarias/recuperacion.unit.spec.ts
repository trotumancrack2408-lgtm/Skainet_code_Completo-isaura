...
describe('PRUEBAS UNITARIAS - Recuperación de Contraseña (RF-003)', () => {
   ...
   * Tipo: UNITARIA
   * Objetivo: Formato email rec. inválido.
   * Criterio de Aceptación: Rechazo preventivo de correos con formato no válido.
   * --------------------------------------------------------------------------
   */
   ...
   * Requerimiento: RF-003
   * Tipo: UNITARIA
   * Objetivo: Coincidencia de nueva clave.
   * Criterio de Aceptación: La nueva contraseña y su confirmación deben ser exactamente iguales.
   * --------------------------------------------------------------------------
   */
