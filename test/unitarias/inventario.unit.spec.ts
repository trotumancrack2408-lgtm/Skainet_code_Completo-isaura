...
describe('PRUEBAS UNITARIAS - Inventario de Materia Prima (RF-004)', () => {
   ...
   * Tipo: UNITARIA
   * Objetivo: Gramaje negativo o cero.
   * Criterio de Aceptación: Si se intenta registrar una entrada/salida de gramos <= 0, lanzar BadRequestException.
   * --------------------------------------------------------------------------
   */
   ...
   * Requerimiento: RF-004
   * Tipo: UNITARIA
   * Objetivo: Tipo de material inválido.
   * Criterio de Aceptación: Restricción de selección a categorías/leyes válidas del catálogo de metales.
   * --------------------------------------------------------------------------
   */
   ...
   * Requerimiento: RF-004
   * Tipo: UNITARIA
   * Objetivo: Campos requeridos material.
   * Criterio de Aceptación: Si faltan campos obligatorios (nombre, categoría, unidad), lanzar BadRequestException.
   * --------------------------------------------------------------------------
   */
