...
describe('PRUEBAS UNITARIAS - Gestión de Clientes (RF-011)', () => {
  /**
   * --------------------------------------------------------------------------
   * CASO DE PRUEBA: CP-140
   * --------------------------------------------------------------------------
   * Requerimiento: RF-011
   * Tipo: UNITARIA
   * Objetivo: Documento cliente duplicado.
   * Criterio de Aceptación: Lanzar BadRequestException si la cédula/NIT del cliente ya está registrada.
   * --------------------------------------------------------------------------
   */
