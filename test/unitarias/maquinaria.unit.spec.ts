...
describe('PRUEBAS UNITARIAS - Control de Maquinaria (RF-007)', () => {
  /**
   * --------------------------------------------------------------------------
   * CASO DE PRUEBA: CP-115
   * --------------------------------------------------------------------------
   * Requerimiento: RF-007
   * Tipo: UNITARIA
   * Objetivo: Campos requeridos equipo.
   * Criterio de Aceptación: Lanzar BadRequestException si se intenta crear una máquina omitiendo nombre o tipo.
   * --------------------------------------------------------------------------
   */
