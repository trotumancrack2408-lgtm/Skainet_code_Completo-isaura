...
describe('PRUEBAS UNITARIAS - Seguridad y Desastres (RF-014)', () => {
  /**
   * --------------------------------------------------------------------------
   * CASO DE PRUEBA: CP-155
   * --------------------------------------------------------------------------
   * Requerimiento: RF-014
   * Tipo: UNITARIA
   * Objetivo: Cifrado de datos sensibles.
   * Criterio de Aceptación: Verificar que el hash generado por bcrypt sea diferente al texto plano y pueda ser verificado.
   * --------------------------------------------------------------------------
   */
